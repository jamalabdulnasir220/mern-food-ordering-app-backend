...
router.get("/restaurants", jwtCheck, parseJwt, adminCheck, getAllRestaurants);
router.put("/restaurants/:restaurantId/approval-status", jwtCheck, parseJwt, adminCheck, updateRestaurantApprovalStatus);
